...
public class VideoServiceImpl implements VideoService {
    ...
    public VideoMonoRecord getVideoChunk(String name, String rangeHeader){
        ...
        try {
            ...
            return new VideoMonoRecord("video/mp4","bytes 0-0",0,Mono.error(new ResponseStatusException(HttpStatus.NOT_FOUND, "Video not found")));
        }
        ...
        try {
            ...
            log.error(e.toString());
            return new VideoMonoRecord("video/mp4", "bytes 0-0", 0, Mono.error(new ResponseStatusException(HttpStatus.NOT_FOUND, "IO Error")));
        }
        long start = 0;
        ...
        String rangeRes = "bytes " + finalStart + "-" + finalEnd + "/" + fileLength;
